...
int killproc(int pid) {
	return invoke_syscall(SYSCALL_KILLPROC, pid, IGNORE, IGNORE);
}

int psproc(int pid, ps_t *ps) {
	return invoke_syscall(SYSCALL_PSPROC, pid, (int)ps, IGNORE);
}

int susproc(int pid) {
	return invoke_syscall(SYSCALL_SUSPROC, pid, IGNORE, IGNORE);
}

int resproc(int pid) {
	return invoke_syscall(SYSCALL_RESPROC, pid, IGNORE, IGNORE);
}
