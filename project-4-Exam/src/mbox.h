...
enum
{
	MAX_MBOX = 6,       /* max number of mailboxes */
...
/*
 * Open a mailbox with the key 'key'. Returns a mailbox handle
 * which must be used to identify this mailbox in the
 * following functions (parameter q).
 */
...
/* Debug function  */
void print_mbox_status(mbox_t *q);
