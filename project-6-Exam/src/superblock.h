...
struct disk_superblock {
	...
	int table_placement; /* where the inode table starts */
	int bitmap_placement; /* where the bitmap starts */
};
...
struct mem_superblock {
	...
	int ibmap; /* bitmap for inodes */
	int dbmap; /* bitmap for data blocks */
	char dirty;
};
